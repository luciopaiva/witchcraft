...
Just name your script using the IP address. For instance, if you want to load a script when accessing `http://10.0.0.1`, name your script `10.0.0.1.js`.

## Can I install Witchcraft from sources instead?

Yes, you can install Witchcraft directly from sources instead of downloading it from the Chrome store. Just build it and manually load it as an unpacked extension. Check the Chrome documentation [here](https://developer.chrome.com/docs/extensions/get-started/tutorial/hello-world#load-unpacked).
