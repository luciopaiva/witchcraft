...
describe("Witchcraft", function (){
  ...
  it('should return corect scriptMode for mode directives', async function (){
    ...
    const scriptContents = [
      {
        content  : `console.log('alsdkfjasldkjf');
       let a=1;
       return a;
       `,
        expected : Witchcraft.MODE_FN
      },
      {
        content : `//@mode=1
       console.log('alsdkfjasldkjf');
       let a=1;
       return a;
       `, expected : 1
      }, {
        content               :
          `//@mode=2 should be ignored
       console.log('alsdkfjasldkjf');
       let a=1;
       return a;
       `, expected : 2
       ...
       `,
        ...
        content  : `    
         //@mode=2 success
        console.log('empty first line will result in default value');
       let a=1;
       return a;
       `,
        expected : defaultValue
           ...
           {
        content  : `             //@mode=2 success
        console.log('blanks at beginning is ok');
       let a=1;
       return a;
       `,
        expected : 2
    ...
    assert.strictEqual( results.length,scriptContents.length);
